...
document.querySelectorAll(".menu_link").forEach((n) =>
...
let modalBtnWinterSwimming = document.getElementById(
  "winter-swimming-modal-btn"
);
let modalWinterSwimming = document.querySelector(".winter-swimming-modal");
let closeBtnWinterSwimming = document.querySelector(
  ".winter-swimming-close-btn"
);
